...
public class PriorityController {
    ...
    public ResponseEntity<Priority> add(@RequestBody Priority priority) {
        ...
        if (priority.getId() != null && priority.getId() != 0) {
            ...
            // поэтому его передавать не нужно, иначе может быть конфликт уникальности значения
    ...
    // для удаления используем типа запроса put, а не delete,
    // т.к. он позволяет передавать значение в body, а не в адресной строке
    ...
    public ResponseEntity<List<Priority>> search(@RequestBody PrioritySearchValues prioritySearchValues) {
        ...
        return ResponseEntity.ok(priorityService.find(
